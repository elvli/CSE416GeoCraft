                ...
                <Row>
                  <Col xs="auto">
                    <Row xs="auto" className='like-comment-number'>
                      ...
                      <Button onClick={()=>{setLikeButton(!likeButton)}} className='btn btn-light like-dislike-button'>{likeButton? <HandThumbsUpFill/>:<HandThumbsUp/>}</Button>
                      {likeButton?1:0}
                    </Row>

                  </Col>
                  <Col xs="auto">
                    <Button onClick={()=>{setDislikeButton(!dislikeButton)}} className='btn btn-light like-dislike-button'>{dislikeButton? <HandThumbsDownFill/>:<HandThumbsDown/>}</Button>
                  </Col>
                  <Col >
                  <Button className='btn btn-light reply-link'>Reply</Button>
                  </Col>
                </Row>
              </Col>
          </Row>
